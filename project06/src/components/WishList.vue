    ...
    <section>
        <transition-group name="list" tag="ul">
            <li v-for="(wishItem, index) in propsData" v-bind:key="wishItem.key" class="shadow">
                <i class="checkBtn fas fa-check" aria-hidden="turn"></i>
                {{wishItem.value}}
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            editWishAction(keyOfWishItem, inde, editText){
...
<style lang="css" scoped>
    ...
    input{border-style: groove; width: 275px; padding: 5px 10px; border-radius: 5px; margin-top: 15px; font-size: 14px;}
